...
const detailModules: Record<string, Record<string, () => Promise<{ default: unknown }>>> = {
  pt: {
    ...
    video_factory: () => import('@/locales/pt/projects_details/video_factory.json'),
  ...
  en: {
    ...
    canaoaves: () => import('@/locales/en/projects_details/canaoaves.json'),
    eupizza: () => import('@/locales/en/projects_details/eupizza.json'),
    sdlc_ia: () => import('@/locales/en/projects_details/sdlc_ia.json'),
    spider_hub: () => import('@/locales/en/projects_details/spider_hub.json'),
    toot: () => import('@/locales/en/projects_details/toot.json'),
    shosales: () => import('@/locales/en/projects_details/shosales.json'),
    favorite_products: () => import('@/locales/en/projects_details/favorite_products.json'),
    onepush: () => import('@/locales/en/projects_details/onepush.json'),
    video_factory: () => import('@/locales/en/projects_details/video_factory.json'),
    semantic_cache: () => import('@/locales/en/projects_details/semantic_cache.json'),
    pyspark: () => import('@/locales/en/projects_details/pyspark.json'),
